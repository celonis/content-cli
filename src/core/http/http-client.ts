...
export class HttpClient {
    ...
    public async post(url: string, body: any): Promise<any> {
        ...
        const requestBody =
            typeof body === "string" || body instanceof String || body instanceof FormData
                ? body
                : JSON.stringify(body);
        return new Promise<any>((resolve, reject) => {
            this.axios
                .post(this.resolveUrl(url), requestBody, {
    ...
    public async put(url: string, body: object): Promise<any> {
        return new Promise<any>((resolve, reject) => {
            this.axios
                .put(this.resolveUrl(url), JSON.stringify(body), {
