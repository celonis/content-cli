...
export class DeploymentApi {
  ...
  public async getActiveDeploymentsForPackage(
    ...
    return this.httpClient()
      .get(
        `/pacman/api/deployments/packages/${packageKey}/active?${queryParams.toString()}`,
      )
      .catch(e => {
        throw new FatalError(
          `Problem getting active deployments for package ${packageKey}: ${e}`,
        );
      });
  }
  ...
  public async getActiveDeploymentForTarget(
    ...
    return this.httpClient()
      ...
      .catch(e => {
        throw new FatalError(
          `Problem getting active deployment for target ${targetId}: ${e}`,
        );
      });
  }
