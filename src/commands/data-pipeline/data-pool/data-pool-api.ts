import {
  DataPoolInstallVersionReport,
  DataPoolPageTransport,
} from "./data-pool-manager.interfaces";
...
export class DataPoolApi {
  ...
  public async findAllPagedPools(
    limit: string,
    page: string,
  ): Promise<DataPoolPageTransport> {
  ...
  public async executeDataPoolsBatchImport(
    importRequest: string,
  ): Promise<DataPoolInstallVersionReport> {
    return this.httpClient()
  ...
  public async getTypedConnection(
    poolId: string,
    connectionId: string,
    type: string,
  ): Promise<any> {
  ...
  public async updateTypedConnection(
    poolId: string,
    connectionId: string,
    type: string,
    data: any,
