...
export class StudioVariablesApi {
  ...
  public async assignVariableValues(
    ...
    return this.httpClient()
      .post(
        `/package-manager/api/nodes/by-package-key/${packageKey}/variables/values`,
        variablesAssignments,
      )
      .catch(e => {
        throw new FatalError(
          `Problem updating variables of package ${packageKey}: ${e}`,
        );
      });
  }

  public async getRuntimeVariableValues(
    packageKey: string,
    appMode: string,
  ): Promise<VariablesAssignments[]> {
    ...
    return this.httpClient()
      ...
      .catch(e => {
        throw new FatalError(
          `Problem getting runtime variables of package ${packageKey}: ${e}`,
        );
      });
  }
}
