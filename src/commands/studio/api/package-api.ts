...
export class PackageApi {
  ...
  public async exportPackage(
    ...
    queryParams.set(
      "excludeActionFlows",
      excludeActionFlows ? "true" : "false",
    );

    return await this.httpClient()
      .downloadFile(
        `/package-manager/api/packages/${rootPackageKey}/export?${queryParams.toString()}`,
      )
      .catch(e => {
        throw new FatalError(
          `Package ${rootPackageKey}_${version} failed to export.`,
        );
      });
  }
  ...
  public async findAllPackagesWithVariableAssignments(
    ...
    return this.httpClient()
      .get(
        `/package-manager/api/packages/with-variable-assignments?${queryParams.toString()}`,
      )
      .catch(e => {
  ...
  public async findLatestVersionById(
    nodeId: string,
  ): Promise<PackageHistoryTransport> {
    return this.httpClient()
  ...
  public async findActiveVersionById(
    nodeId: string,
  ): Promise<PackageHistoryTransport> {
    return this.httpClient()
  ...
  public async findActiveVersionByIds(
    nodeIds: string[],
  ): Promise<PackageHistoryTransport[]> {
    return this.httpClient()
      ...
      .catch(e => {
        throw new FatalError(
          `Problem getting latest version of packages: ${e}`,
        );
      });
  }

  public async findNextVersion(
    nodeId: string,
  ): Promise<PackageHistoryTransport> {
    return this.httpClient()
  ...
  public async movePackageToSpace(
    nodeId: string,
    spaceId: string,
  ): Promise<void> {
    await this.httpClient()
  ...
  public async publishPackage(
    activatePackage: ActivatePackageTransport,
  ): Promise<void> {
    await this.httpClient()
      .post(
        `/package-manager/api/packages/${activatePackage.packageKey}/activate`,
        activatePackage,
      )
      .catch(e => {
        throw new FatalError(
          `Problem activating package with key ${activatePackage.packageKey}: ${e}`,
        );
      });
  }
}
