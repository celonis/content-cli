...
export class BatchImportExportApi {
  ...
  public async findAllActivePackages(
    flavors: string[],
    ...
    return this.httpClient()
      .get(
        `/package-manager/api/core/packages/export/list?${queryParams.toString()}`,
      )
      .catch(e => {
  ...
  public async findActivePackagesByVariableValue(
    flavors: string[],
    ...
    return this.httpClient()
      .get(
        `/package-manager/api/core/packages/export/list-by-variable-value?${queryParams.toString()}`,
      )
      .catch(e => {
        throw new FatalError(
          `Problem getting active packages by variable value: ${e}`,
        );
      });
  }

  public async findActivePackagesByKeys(
    packageKeys: string[],
    withDependencies: boolean = false,
  ): Promise<PackageExportTransport[]> {
    const queryParams = new URLSearchParams();
    ...
    return this.httpClient()
      .get(
        `/package-manager/api/core/packages/export/list-by-keys?${queryParams.toString()}`,
      )
      .catch(e => {
  ...
  public async exportPackages(
    ...
    packageKeys.forEach(packageKey =>
      queryParams.append("packageKeys", packageKey),
    );
    queryParams.set("withDependencies", withDependencies.toString());

    return this.httpClient()
      .getFile(
        `/package-manager/api/core/packages/export/batch?${queryParams.toString()}`,
      )
      .catch(e => {
  ...
  public async exportPackagesByVersions(
    packageKeysWithVersion: string[],
    withDependencies: boolean,
  ): Promise<Buffer> {
    const queryParams = new URLSearchParams();
    packageKeysWithVersion.forEach(packageKeyByVersion =>
      queryParams.append("packageKeysWithVersion", packageKeyByVersion),
    );
    queryParams.set("withDependencies", withDependencies.toString());

    return this.httpClient()
      .getFile(
        `/package-manager/api/core/packages/versions/export/batch?${queryParams.toString()}`,
      )
      .catch(e => {
  ...
  public async batchExportPackagesMetadata(
    packageKeys: string[],
  ): Promise<PackageMetadataExportTransport[]> {
    const queryParams = new URLSearchParams();
    packageKeys.forEach(packageKey =>
      queryParams.append("packageKeys", packageKey),
    );
    ...
    return this.httpClient()
      .get(
        `/package-manager/api/core/packages/metadata/export?${queryParams.toString()}`,
      )
      .catch(e => {
  ...
  public async findVariablesWithValuesByPackageKeysAndVersion(
    packagesByKeyAndVersion: PackageKeyAndVersionPair[],
  ): Promise<VariableManifestTransport[]> {
    return this.httpClient()
      .post(
        "/package-manager/api/core/packages/export/batch/variables-with-assignments",
