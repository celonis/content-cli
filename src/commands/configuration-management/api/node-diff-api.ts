...
export class NodeDiffApi {
  ...
  public async diff(
    request: GetNodeDiffRequest,
  ): Promise<NodeConfigurationDiffTransport> {
    ...
    return this.httpClient()
      .get(
        `/pacman/api/core/packages/${request.packageKey}/nodes/${request.nodeKey}/diff/configuration?${queryParams.toString()}`,
      )
      .catch(exception => {
