...
class Module extends IModule {
    public register(context: Context, configurator: Configurator): void {
        ...
        const metadataCommand = configCommand.command("metadata").description("Commands related to package metadata");
        ...
        const variablesCommand = configCommand.command("variables").description("Commands related to variable configs");
        ...
        const nodesCommand = configCommand.command("nodes").description("Commands related to nodes of the package");
