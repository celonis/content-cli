...
export class ConfigUtils {
  public static buildBatchExportZipWithStudioManifest(
    manifest: PackageManifestTransport[],
    studioManifest: StudioPackageManifest[],
    packageZips: AdmZip[],
  ): AdmZip {
  ...
  public static buildBatchExportZip(
    manifest: PackageManifestTransport[],
    packageZips: AdmZip[],
  ): AdmZip {
    const zipExport = new AdmZip();
  ...
  public static buildExportPackageZip(
    packageNode: NodeExportTransport,
    childNodes: NodeExportTransport[],
    version: string,
  ): AdmZip {
    const zipExport = new AdmZip();
    ...
    childNodes.forEach(child => {
      zipExport.addFile(
        `nodes/${child.key}.json`,
        Buffer.from(stringify(child)),
      );
    });
  ...
  public static buildManifestForKeyAndFlavor(
    ...
    return {
      ...
      dependenciesByVersion:
        dependenciesByVersion ?? ({} as Map<string, DependencyTransport[]>),
    };
  }

  public static buildManifestForKeyAndFlavorAndVersion(
    key: string,
    flavor: string,
    version: string,
    dependenciesByVersion?: Map<string, DependencyTransport[]>,
  ...
  public static buildPackageNode(
    key: string,
  ...
  public static buildStudioManifestForKeyWithSpace(
    key: string,
    spaceName: string,
    spaceId: string,
  ): StudioPackageManifest {
