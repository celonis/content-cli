...
describe("Deployment list active", () => {
    ...
    it("Should list active deployment for target as JSON", async () => {
        ...
        const deploymentTransport = getJsonFromFile(expectedFileName) as DeploymentTransport;
    ...
    it("Should list active deployments for package", async () => {
        ...
        mockAxiosGet(`https://myTeam.celonis.cloud/pacman/api/deployments/packages/${packageKey}/active?limit=100&offset=0`, [deployment]);
    ...
    it("Should list active deployments for package with targetIds filter", async () => {
        ...
        mockAxiosGet(`https://myTeam.celonis.cloud/pacman/api/deployments/packages/${packageKey}/active?limit=100&offset=0&targetIds=${targetIds.join("%2C")}`, [deployment]);
    ...
    it("Should list active deployments for package as JSON", async () => {
        ...
        const deploymentTransports = getJsonFromFile(expectedFileName) as DeploymentTransport[];
