...
describe("Deployments list history", () => {
    ...
    it("Should list deployment history", async () => {
        mockAxiosGet("https://myTeam.celonis.cloud/pacman/api/deployments/history?limit=100&offset=0", [
            deploymentTransport,
        ]);
    ...
    it("Should list deployment history with pagination params", async () => {
        mockAxiosGet("https://myTeam.celonis.cloud/pacman/api/deployments/history?limit=3&offset=3", [
            deploymentTransport,
        ]);
