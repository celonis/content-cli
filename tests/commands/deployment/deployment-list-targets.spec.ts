import { DeployableTransport, TargetTransport } from "../../../src/commands/deployment/deployment.interfaces";
...
describe("Deployment list targets", () => {
    ...
    it("Should list targets as JSON", async () => {
        ...
        const secondTargetTransport = targetTransports.filter(transport => transport.name === secondTarget.name)[0];
