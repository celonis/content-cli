...
describe("Config import", () => {
    ...
    it.each([
        ...
        await new ConfigCommandService(testContext).batchImportPackages("./export_file.zip", overwrite);
    ...
    it("Should fail to map space ID as the space id specified in manifest file cannot be found", async () => {
        ...
        await expect(
            new ConfigCommandService(testContext).batchImportPackages("./export_file.zip", true)
