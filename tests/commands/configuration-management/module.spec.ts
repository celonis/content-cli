...
jest.mock(
  "../../../src/commands/configuration-management/config-command.service",
);
jest.mock(
  "../../../src/commands/configuration-management/node-dependency.service",
);
...
describe("Configuration Management Module - Action Validations", () => {
  ...
  beforeEach(() => {
    ...
    (
      ConfigCommandService as jest.MockedClass<typeof ConfigCommandService>
    ).mockImplementation(() => mockConfigCommandService);
    (
      NodeDependencyService as jest.MockedClass<typeof NodeDependencyService>
    ).mockImplementation(() => mockNodeDependencyService);
  });
  ...
  describe("batchExportPackages validation", () => {
    describe("packageKeys and keysByVersion validation", () => {
      it("should throw error when both packageKeys and keysByVersion are provided", async () => {
        ...
        await expect(
          (module as any).batchExportPackages(
            testContext,
            mockCommand,
            options,
          ),
        ...
        expect(
          mockConfigCommandService.batchExportPackages,
      ...
      it("should pass validation when only packageKeys is provided", async () => {
        ...
        await (module as any).batchExportPackages(
          testContext,
          mockCommand,
          options,
        );
    ...
    describe("withDependencies option", () => {
      ...
      it("should pass unzip option when provided", async () => {
        ...
        expect(
          mockConfigCommandService.batchExportPackages,
        ).toHaveBeenCalledWith(["package1"], undefined, false, undefined, true);
      });
    });
  ...
  describe("batchImportPackages validation", () => {
    describe("gitProfile and gitBranch validation", () => {
      it("should throw error when gitProfile is provided without gitBranch option", async () => {
        ...
        await expect(
          (module as any).batchImportPackages(
            testContext,
            mockCommand,
            options,
          ),
        ...
        expect(
          mockConfigCommandService.batchImportPackages,
        ).not.toHaveBeenCalled();
      });
      ...
      it("should pass validation when gitProfile is provided with gitBranch option", async () => {
        ...
        await (module as any).batchImportPackages(
          testContext,
          mockCommand,
          options,
        );
        ...
        expect(
          mockConfigCommandService.batchImportPackages,
        ).toHaveBeenCalledWith("export.zip", undefined, undefined, "main");
      });
      ...
      it("should pass validation when gitBranch is provided without gitProfile in context", async () => {
        ...
        expect(
          mockConfigCommandService.batchImportPackages,
        ).toHaveBeenCalledWith(undefined, "./exported", undefined, "develop");
      });
      ...
      it("should pass validation when neither gitProfile in context nor gitBranch in options are provided", async () => {
        ...
        expect(
          mockConfigCommandService.batchImportPackages,
        ).toHaveBeenCalledWith("export.zip", undefined, undefined, undefined);
      });
    });
    ...
    describe("import options", () => {
      ...
      it("should pass directory option correctly", async () => {
        ...
        expect(
          mockConfigCommandService.batchImportPackages,
        ).toHaveBeenCalledWith(undefined, "./my-exports", undefined, undefined);
      });
      ...
      it("should pass overwrite option correctly", async () => {
        ...
        expect(
          mockConfigCommandService.batchImportPackages,
        ).toHaveBeenCalledWith("export.zip", undefined, true, undefined);
      });
      ...
      it("should handle all options together", async () => {
        ...
        expect(
          mockConfigCommandService.batchImportPackages,
        ).toHaveBeenCalledWith(undefined, "./exports", true, "feature-branch");
      });
    });
  });
  ...
  describe("listNodeDependencies", () => {
    it("should call listNodeDependencies with correct parameters", async () => {
      ...
      await (module as any).listNodeDependencies(
        testContext,
        mockCommand,
        options,
      );
      ...
      expect(
        mockNodeDependencyService.listNodeDependencies,
      ).toHaveBeenCalledWith("test-package", "test-node", "1.0.0", undefined);
    });
    ...
    it("should pass json option when provided", async () => {
      ...
      expect(
        mockNodeDependencyService.listNodeDependencies,
      ).toHaveBeenCalledWith("test-package", "test-node", "2.0.0", true);
    });
    ...
    it("should handle all parameters correctly", async () => {
      ...
      expect(
        mockNodeDependencyService.listNodeDependencies,
      ).toHaveBeenCalledWith("my-package", "my-node", "1.2.3", true);
    });
  });
});
